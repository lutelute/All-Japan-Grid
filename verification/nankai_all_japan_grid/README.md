...
| `slides_visual_candidates.pptx` | **検討用 7 枚**：地震と津波の到達表現 4 案（現行 / L1 物理の時計 / L2 海面を解く / L3 カメラ）の比較、到達時刻の検算（内閣府 2025 ケース②と照合）、復旧オペレーション試作。動く GIF 5 本。説明は `VISUAL_CANDIDATES.md` |
