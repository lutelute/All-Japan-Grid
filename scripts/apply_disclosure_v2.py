...
def main() -> int:
    ...
    OUT.write_text(json.dumps({
        ...
        "map_reading_notes": [
            ...
            "【負の証拠】新潟市街の青山一丁目/ときめき東一丁目/平五丁目/渋川、盛岡の門前寺、"
            "南相馬の原町区大谷は、公表66kV系統図(local02/06/07)にも潮流実績CSVにも不在"
            "→東北NWの66kV系統設備でない可能性(配電<66kV or 他社)。A判定の降格候補として"
            "人間確認待ち(OSMのkv=66タグを疑う)",
