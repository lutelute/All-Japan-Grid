...
<div class="caption"><span class="fig-num">図.</span> 上: 停電の原因(需要に対する平均)。下: 受電を続ける独立系統の数。西は 10 分後に 2 個以上が 57%(既定。過負荷リレーの扱いで 16〜57%)、最大 6 個。</div>

---

<!-- _class: table-slide -->
<!-- source: run_v2_dyn / run_v2_dyn_ol275 / run_v2_dyn_nool(同じ乱数・N=200) -->

# 受電率は安定、分かれ方と東の全域崩壊は振れる

| 条件 | 島 | 10 分 受電率 | 3 時間 受電率 | ほぼ全域崩壊 | 10 分で 2 つ以上に分割 |
|---|---|---|---|---|---|
| 全電圧で過負荷リレー | 西 | 70.7% | 60.3% | 2% | 57% |
| 275 kV 以上だけ | 西 | 75.7% | 62.8% | 8% | 16% |
| 過負荷リレーなし | 西 | 81.5% | 67.5% | 2% | 24% |
| 全電圧で過負荷リレー | 東 | 81.0% | 58.9% | 16% | 24% |
| 275 kV 以上だけ | 東 | 84.1% | 37.4% | 55% | 3% |
| 過負荷リレーなし | 東 | 96.6% | 78.9% | 4% | 4% |

<div class="footnote">東では揺れで東京の火力 12.75 GW が止まった後、66 kV の線路に 5,000 MW(容量 137 MW)が流れる。上位電圧の経路が欠けたモデルの弱点で、東の全域崩壊は確率として示せない。</div>
