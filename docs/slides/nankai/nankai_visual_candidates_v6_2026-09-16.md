...
<!-- _class: figure-full -->
<!-- source: All-Japan-Grid 西 60 Hz・run_v7 代表サンプル #81(3 分後の受電が中央値に最も近い) -->
...
<!-- _class: figure-full -->
<!-- source: All-Japan-Grid 東 50 Hz・run_v7 代表サンプル #89(3 分後の受電が中央値に最も近い。東は run_v6 と同一) -->
...
<!-- _class: figure -->
<!-- source: hazard/nankai/output/run_v7(N=200×西・東)/ summarize_dynamic.py -->
...
<!-- _class: table-slide -->
<!-- source: run_v7 / run_v7_nool / run_v6 / run_v6_nool / run_v6_notb / run_v6_notrafo / run_v4_red(同じ乱数・N=200) -->

# 東の崩壊を振らせたのは変圧器の容量の欠け

| 条件 | 島 | 10 分 受電率 | ほぼ全域崩壊 | 10 分で 2 つ以上に分割 |
|---|---|---|---|---|
| 既定(run_v7) | 西 | 67.2% | 4% | 21% |
| 過負荷リレーなし | 西 | 70.3% | 2% | 18% |
| 既定(run_v7) | 東 | 87.0% | 10% | 9% |
| 過負荷リレーなし | 東 | 89.7% | 6% | 8% |
