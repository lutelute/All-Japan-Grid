...
<!-- note: 揺れで火力 21.6 GW(需要の 39%)が止まる。UFLS 2 段 14.0 GW でも足りず、45.2 Hz まで落ちて水力・火力の周波数低下保護が 6.0 GW を解列、127 秒で 34 GW が崩壊する。200 サンプルのうち全域崩壊は 20 で、揺れの直後に崩れる型が 2、津波の後に崩れる型が 18。 -->
...
<li>津波後の崩壊は鹿島の系統の切り離しが引き金(20 例中 18 例がこの型)</li>
