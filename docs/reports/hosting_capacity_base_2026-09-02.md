# 地点別の接続可能量 — 感度行列で一度に出す（base_2026-09-02）
...
|---|---:|---:|---:|---|
| east | 5,799 | 4.48 s | **710 ミリ秒** | 5,799 回の AC 求解 ≈ **4.3 日** |
| west | 7,456 | 7.56 s | **688 ミリ秒** | 7,456 回の AC 求解 ≈ **3.6 日** |
...
| 島 | 中央値 | 良い側10% | 悪い側10% |
|---|---:|---:|---:|
| east | 158.3 %/GW | 61.6 %/GW | 381.5 %/GW |
| west | 170.1 %/GW | 61.3 %/GW | 454.1 %/GW |
...
|---|---:|---:|---:|---:|---:|
| east | — | — | — | 0 | 0 |
| west | 391 MW | 229 MW | 2,676 MW | 0 | 1 |

## 算出できた地点と、できなかった理由

| 島 | 算出できた地点 | 制約対象の枝 | うち既に容量超過 |
|---|---:|---:|---:|
| east | 0 / 5,799 | 2,109 / 6,906 (154kV以上) | 211 |
| west | 8 / 7,456 | 3,206 / 8,873 (154kV以上) | 165 |
...
![接続可能量の地図](../assets/sensitivity/hosting_capacity_base_2026-09-02.png)
