...
- **【続き・負の結果】鹿島の接続を公表どおりに張り直す試み**(`branch_removals` を追加・`branch_additions` の後に実行): 足した= 鹿島火力線 北浜↔鹿島変電所(公表「鹿島変電所—鹿島火力発電所 275 kV 5.0 km」・モデル直線 4.4 km)・香取線 1・2L 鹿島↔新佐原・鹿島線 1・2L 鹿島↔筑波南、外した= 鰐川→新佐原・鰐川→筑波南(OSM 吸着で付け替わった同じ線路)。結果は **全域崩壊 18→14 だが内訳が反転(直後 3→10・後 15→4)**、10 分受電率 87.0→83.3%、3 時間 73.0→77.1%。**津波後の崩壊はほぼ消えるが、揺れの直後の崩壊が増える**。原因は送り出し容量が半減(鰐川経由 7,620 MW → 公表どおり 3,810 MW)で、運転中 4.9 GW が行き場を失うため。**真因はモデルに鹿島周辺の 500 kV が丸ごと無いこと**: TEPCO 設備計画の「鹿島海浜線(鹿島火力発電所構内開閉所)1 番線 **500 kV**」をモデルは 275 kV 2 回線で持ち、open-keitouzu の **東鹿島変電所は存在しない**。北緯 35.7〜36.1・東経 140.4〜140.9 に 500 kV の母線も枝も 0。**張り直しだけでは直らないので既定は run_v9 のままとし、張り直し版と合わせて上下の括りとして読む**
