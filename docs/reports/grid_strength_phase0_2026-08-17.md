...
## ネットワーク表示版(課題①への回答 2026-08-17)

![系統強度ネットワーク図](figs/grid_strength_network_2026-08-17.png)

点表示の理由=S_scがバス(節点)量だから。「回廊は弱い方の端に支配される」
(線の色=min(両端S_sc))でネットワークへ写像した。18,769線分・スキップ13。
